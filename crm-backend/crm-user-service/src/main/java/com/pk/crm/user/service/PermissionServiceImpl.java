...
public class PermissionServiceImpl implements PermissionService {
    ...
    public PermissionDTO createPermission(PermissionDTO permissionDTO) {
        ...
        try {
            ...
            throw new RuntimeException("创建权限失败，数据库操作异常", e);
        }
    }
    ...
    public PermissionDTO updatePermission(PermissionDTO permissionDTO) {
        ...
        try {
            ...
            throw new RuntimeException("更新权限失败，数据库操作异常", e);
        }
    }
    ...
    public void deletePermission(Long id) {
        ...
        if (permissionMapper.countByParentId(id) > 0) {
            throw new ValidationException("无法删除，请先删除其子权限");
        }
    ...
    public List<PermissionDTO> getAllPermissions() {
        ...
        try {
            ...
            throw new RuntimeException("获取权限列表失败，数据库操作异常", e);
        }
    }
    ...
    public List<PermissionDTO> searchPermissions(String keyword) {
        ...
        try {
            return permissionMapper.searchPermissions(keyword.trim());
        } catch (DataAccessException e) {
    ...
    private List<PermissionDTO> buildPermissionTree(List<PermissionDTO> allPermissions) {
        ...
        rootPermissions.forEach(permission -> buildChildren(permission, permissionMap));
